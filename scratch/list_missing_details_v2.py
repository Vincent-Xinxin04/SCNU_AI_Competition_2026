...
with open(r'f:\github\SCNU_AI_Competition_2026\scratch\missing_details.txt', 'w', encoding='utf-8') as out_f:
    out_f.write(f"Total missing labels: {len(missing_labels)}\n")
    for l in missing_labels:
        ...
        out_f.write(f"Label: '{l}' (samples: {len(samples)}): {', '.join(samples)}\n")
